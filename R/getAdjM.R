...
#' protein.
#' @return a \code{numerical} \code{matrix} containing the adjacency matrix, with
...
getAdjM <- function(incM){
  ...
  ## Replace all values on diagonal (which represent the connection of a transcript
  ## with itself) by 0. This allows to have a sparser matrix and speed up the code.
