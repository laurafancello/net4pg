...
#' original complete incidence matrix or a reduced veriosn of it which only contains
...
#' multi-protein CCs; iv. a \code{data.frame} describing size distribtion of
